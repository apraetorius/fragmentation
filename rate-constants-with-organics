...
P4_0 = 0
y0= [P0_0, P1_0, P2_0,P3_0, P4_0]      # initial condition vector
...
def score(parms):
    ...
    F0,F1,F2,F3,F4,T=eq(parms,y0,start_time,end_time,intervals)
...
#c.Score Difference between model and data points
    ...
    return ss(M1,Zm)+ss(M2,Zm2)+ss(M3,Zm3)+ss(M4,Zm4)
#========================================================
...
answ=fmin(score,(rates),full_output=1,maxiter=20000)
bestrates=answ[0]
bestscore=answ[1]
k1,k2,k3,k4=answ[0]
...
#=======================================================
#F0,F1,F2,F3,F4,T=eq(newrates,y0,start_time,end_time,intervals)
#my_list = [0, 50, 99]
#Zm=F0[my_list]
#Tm=T[my_list]
#======================================================
